...
const file_greet_proto_rawDesc = "" +
	...
	"\aGreeter\x12;\n" +
	"\x05Greet\x12\x18.grpcserver.GreetRequest\x1a\x16.grpcserver.GreetReply\"\x00BPZNgithub.com/carlosetorresm/go-with-tests/21-acceptance-test/adapters/grpcserverb\x06proto3"
