...
const file_greet_proto_rawDesc = "" +
	...
	"\x05Curse\x12\x18.grpcserver.CurseRequest\x1a\x16.grpcserver.CurseReply\"\x00BPZNgithub.com/carlosetorresm/go-with-tests/21-acceptance-test/adapters/grpcserverb\x06proto3"
